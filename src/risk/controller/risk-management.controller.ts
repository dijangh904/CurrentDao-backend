...
export class RiskManagementController {
  ...
  @ApiResponse({ status: 200, description: 'Risk assessment history retrieved successfully' })
  ...
  async startMonitoring(@Body() monitoringDto: RiskMonitoringDto) {
    ...
    return { message: 'Real-time monitoring started', portfolioId: monitoringDto.portfolioId };
  }
  ...
  @ApiResponse({ status: 200, description: 'Hedging strategy created successfully' })
  ...
  @ApiParam({ name: 'portfolioId', description: 'Portfolio ID' })
  @ApiResponse({ status: 200, description: 'Hedging performance evaluated successfully' })
  ...
  @ApiParam({ name: 'portfolioId', description: 'Portfolio ID' })
  @ApiResponse({ status: 200, description: 'Hedging strategy adjusted successfully' })
  ...
  @ApiResponse({ status: 200, description: 'VaR calculation completed successfully' })
  ...
  @ApiParam({ name: 'portfolioId', description: 'Portfolio ID' })
  @ApiQuery({ name: 'confidence', description: 'Confidence level (0.95-0.99)', required: false })
  @ApiQuery({ name: 'timeHorizon', description: 'Time horizon in days', required: false })
  @ApiResponse({ status: 200, description: 'VaR methods comparison completed successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Stress test library retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Risk report generated successfully' })
  ...
  @ApiParam({ name: 'portfolioId', description: 'Portfolio ID' })
  @ApiResponse({ status: 200, description: 'Risk dashboard data retrieved successfully' })
  ...
  @ApiQuery({ name: 'severity', description: 'Filter by severity level', required: false })
  @ApiQuery({ name: 'portfolioId', description: 'Filter by portfolio ID', required: false })
  ...
  @ApiResponse({ status: 200, description: 'Risk metrics summary retrieved successfully' })
  ...
  private async getDashboardData(portfolioId: string): Promise<object> {
    ...
    return {
      ...
      overview: {
        ...
        varValue: varComparison.lowestVar,
        hedgingEffectiveness: hedgingPerformance.actualEffectiveness,
        stressTestResilience: stressTestResults.summary.overallResilience,
      },
      charts: {
        riskTrend: await this.getRiskTrendData(portfolioId),
        varComparison: varComparison,
        stressTestResults: stressTestResults.scenarios,
      },
  ...
  private async getAlerts(severity?: string, portfolioId?: string): Promise<object[]> {
